package org.code4j.jproxy.http.head;
 ...
 * 上午1:08
 *
 * 照抄了io.netty.handler.codec.http.HttpResponseStatus
 */
...
public class StatusCode {
    ...
    private static HttpResponseStatus newStatus(int code,String reasonPhrase){
